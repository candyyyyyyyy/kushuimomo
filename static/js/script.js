var LANGUAGES = {
    ...
    "en": {
        ...
        texts: {
            "page-title": "welcome to momoyu",
            "doc-title": "momoyu",
            "page-descriptions": "A little website for the KUSHUI，yes，The girl who knows how to take care of people",
            "counter-descriptions": ["KUSHUI will punch you in the face!", "KUSHUI is a little tired"],
            "counter-unit": "slept",
            "counter-button": ["Give you a punch！", "slept slept！"],
        ...
        texts: {
            "page-title": "welcome to momoyu",
            "doc-title": "給你一拳",
            "page-descriptions": "給枯水寫的小網站，對，就是那個臨終關懷區扛把子UP！",
            "counter-descriptions": ["枯水給了你一拳！", "枯水有點想摸了！"],
            "counter-unit": ["摸", "摸"],
            "counter-button": ["給你一拳！", "摸了摸了！"],
    ...
    "ja": {
        ...
        texts: {
            "page-title": "welcome to momoyu",
            "doc-title": "momoyu",
            "page-descriptions": "枯水のため小さいウェブサイトを書きます，そうです，ホスピスをよく知っている優しい女性!",
            "counter-descriptions": ["枯水はあなたにパンチを与", "枯水ちょっと眠くなりました"],
            "counter-unit": "摸",
            "counter-button": ["一拳！", "おやすみ"],
    ...
    "kr": {
        ...
        texts: {
            "page-title": "welcome to momoyu",
            "doc-title": "momoyu",
            "page-descriptions": "갈수를 위해 쓴 작은 사이트，에 대한，아주 부드러운 그 여자！",
            "counter-descriptions": ["枯水한 대 먹인다", "枯水좀 피곤하다"],
            "counter-unit": "누 워",
            "counter-button": ["한 대 먹인다！", "누 워！"],
